      ...
      <div class="container">
        <div class="card card-profile shadow mt--300">
          <div class="card-header">
            Hello <?=$fet['name'];?>, Submit Your Verification Document
          </div>
            <div class="card-body">
                <form role="form" id="user_doc_verification" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <div class="input-group input-group-alternative mb-3">
                            ...
                            <select class="form-control" name="verifier">
                                ...
                                <?php
                                    $csql = "SELECT * FROM company WHERE status = 1 AND `type` = 'toplevel' ORDER BY id DESC";
                    ...
                    <input name="doc_v_id" type="hidden" value="<?=(!empty($fet['id']))?$fet['id']:'';?>">
        ...
        $('#user_doc_verification').on('submit', function (e) {
            ...
            $.ajax({
                ...
                success:function(data){
                    ...
                    $('.loader').hide();
                    setTimeout(function() {
                        window.location.href = "http://localhost/ruk/add_verification_verif.php";
                    }, 3000);
                },
                error:function () {
