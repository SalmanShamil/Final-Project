...
if (isset($_POST['del'])){
    ...
    $res = mysqli_query($db, "DELETE FROM `verification_v` WHERE `id` = '$id'");
    if ($res){
          ...
          <div class="card shadow">
            <div class="card-header border-0">
              <div class="row align-items-center">
                <div class="col">
                  <h3 class="mb-0">All Sub-Level Verification Requests</h3>
                </div>
              </div>
            </div>
              ...
              <table class="table align-items-center table-flush">
                <thead class="thead-light">
                  <tr>
                    ...
                    <th scope="col">Request Verifier</th>
                    <th scope="col">Top-Level Verifier</th>
                ...
                <tbody>
                <?php
                    $usql = mysqli_query($db, "SELECT * FROM `verification_v` ORDER BY `id` DESC");
                    $i = 1;
                ...
                ?>
                  <tr>
                        ...
                        <td><?=admin_company_user($db, $urow['user_id'])['email'];?></td>
                        <td><?=admin_company_user($db, $urow['com_id'])['email'];?></td>
                        <td><?=$urow['req_submitted'];?></td>
                        <td>
                            <a href="company_verifications.php?del=<?=$urow['id'];?>" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
                        </td>
                  </tr>
                  <?php $i++;}?>
