...
if (isset($_POST['admin_signin'])){
    ...
    if (empty($email) || empty($pass)){
        ...
        $chk = mysqli_query($db, "SELECT * FROM `super-admin` WHERE `email` = '$email'");
        if (mysqli_num_rows($chk) > 0){
            $fet = mysqli_fetch_assoc($chk);

            if ($fet['pass'] != $pass){
                $_SESSION['msg'] = "Password Not Matching";
            }elseif ($fet['status'] != 1){
                $_SESSION['msg'] = "Sorry User not Activated";
            }else{
                $_SESSION['admin'] = $fet['email'];
          ...
          <div class="card bg-secondary shadow border-0">
            ...
            <div class="card-body px-lg-5 py-lg-5">
              <div class="text-center text-muted mb-4">
                <p>Or sign in with admin credentials</p>
              ...
              <form role="form" action="login.php" method="post">
                ...
                <div class="text-center">
                  <button type="submit" class="btn btn-primary my-4" name="admin_signin">Sign in</button>
                </div>
              </form>
            </div>
          </div>
