...
<head>
  ...
  <title>Misujon Development</title>
  <!-- Favicon -->
...
<body>
  <header class="header-global">
    <nav id="navbar-main" class="navbar navbar-main navbar-expand-lg navbar-transparent navbar-light headroom">
      <div class="container">
        <a class="navbar-brand mr-lg-5" href="components.php">
          ...
          <ul class="navbar-nav navbar-nav-hover align-items-lg-center">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu">
                <a href="index.php" class="dropdown-item">Landing</a>
        ...
        <div class="row row-grid justify-content-between align-items-center">
          <div class="col-lg-6">
            ...
            <div class="btn-wrapper">
              ...
              <a href="register.php" class="btn btn-white">Register Page</a>
            </div>
          </div>
      ...
      <div class="row">
        <div class="col-md-6 mb-5 mb-md-0">
          <div class="card card-lift--hover shadow border-0">
            <a href="index.php" title="Landing Page">
