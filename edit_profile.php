...
if (empty($_SESSION['utype']) || $_SESSION['utype'] == 'verifier'){
    header('Location: edit_profilev.php?edi='.$_GET['edi']);
}
?>
                ...
                <form role="form" id="user_update_mi" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <div class="input-group input-group-alternative">
                            ...
                            <input class="form-control datepicker" placeholder="Date of Birth" type="text" name="dob" value="<?=(!empty($fet['dob']))? date('d/m/Y', strtotime($fet['dob'])):'';?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="input-group input-group-alternative">
                    ...
                    <div class="form-group">
                        <div class="col-lg-3">
                            ...
                            <div class="card-profile-image" style="margin-top: 60px;">
                                <a href="#">
                                    <img src="<?=(empty($fet['picture'])) ? 'assets/30-home_default.jpg' : 'assets/signup_images/'.$fet['picture']; ?>" class="rounded-circle" style="max-width: 180px; height: 180px; position: relative;">
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="input-group input-group-alternative">
                            ...
                            <input class="form-control" placeholder="Your Designation" type="text" name="designation" value="<?=(!empty($fet['designation']))? $fet['designation']:'';?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="input-group input-group-alternative">
                            ...
                            <textarea class="form-control" placeholder="Add Short About You" type="text" name="bio" rows="6"><?=(!empty($fet['bio']))? $fet['bio']:'';?></textarea>
                        </div>
                    </div>
                    <div class="row my-4">
                        <div class="col-12">
                    ...
                    <input name="usr_update_prof" type="hidden" value="<?=(!empty($fet['id']))?$fet['id']:'';?>">
          ...
          <div class="card card-profile shadow mt-5">
              ...
              <div class="card-body">
                  <form role="form" id="user_pass_update_mi" method="POST" enctype="multipart/form-data">
                      ...
                      <input name="usr_pass_update_prof" type="hidden" value="<?=(!empty($fet['id']))?$fet['id']:'';?>">
                      <div class="text-center">
        ...
        $('#user_update_mi').on('submit', function (e) {
            ...
            $.ajax({
                ...
                success:function(data){
                    ...
                    $('.loader').hide();
                    setTimeout(function() {
                        window.location.href = "http://localhost/ruk/edit_profile.php?edi="+<?=(!empty($fet['id']))?$fet['id']:'';?>;
                    }, 3000);
                },
                error:function () {
