            ...
            <div class="container">
                <div class="card card-profile shadow mt--300">
                    <div class="card-header">
                        ...
                        <a class="btn btn-1 btn-primary btn-sm pull-right text-white" href="add_verification.php">Add Document &nbsp;<i class="fa fa-plus"></i></a>
                    </div>
                    <div class="card-body">
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                            <?php
                            $bsql = "SELECT * FROM verification WHERE user_id = '".$_SESSION['uid']."'";
