...
if (isset($_GET['ac'])){
    ...
    $acsql = "UPDATE verification SET doc_status = 1 WHERE id = '$acid'";
...
if (isset($_GET['vf'])){
    ...
    $vfsql = "UPDATE verification SET doc_status = 2 WHERE id = '$vfid'";
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        <?php
                            ...
                            $bsql = "SELECT * FROM verification WHERE com_id = '".$_SESSION['uid']."'";
                            ...
                            <tr>
                                ...
                                <th>
                                    <?php if ($bfet['doc_status'] == 0){?>
                                        <a href="vreq.php?ac=<?=$bfet['id'];?>" class="btn btn-1 btn-success btn-sm">Accept Request</a>
                                    <?php }elseif($bfet['doc_status'] == 1){?>
                                        <a href="vreq.php?vf=<?=$bfet['id'];?>" class="btn btn-1 btn-primary btn-sm">Verify Request</a>
